...
int main()
{
  ...
  my_movies.add_movie("American Pie", "R", 1);
  my_movies.add_movie("Iron Man 3", "PG-13", 3);

  my_movies.display_all();
  my_movies.increment_watch_count("Iron Man 3");
  my_movies.display_all();
  my_movies.increment_watch_count("Iron Man 75");
}